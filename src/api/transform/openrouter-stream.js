...
export async function createOpenRouterStream(client, systemPrompt, messages, model, o3MiniReasoningEffort, thinkingBudgetTokens) {
    ...
    let temperature = 0;
    let topP = undefined;
    if (model.id.startsWith("deepseek/deepseek-r1") ||
