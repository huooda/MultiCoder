...
export class PlannerAgent extends BaseAgent {
    constructor(apiHandler, checkpointTracker, eventEmitter) {
     ...
     */
    shouldCreateCoderAgent(taskContent) {
        // 模拟决策逻辑，实际实现将更复杂
        ...
        // 检查任务内容是否包含复杂度指示词
        return complexTaskKeywords.some(keyword => taskContent.toLowerCase().includes(keyword.toLowerCase()));
    }
    /**
     * 创建代码智能体
     */
     ...
     * 处理代码智能体的完成消息
     */
    handleCoderAgentCompletion(message) {
