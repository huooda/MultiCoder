...
import { AgentType, MessageType } from "./types";
/**
 * 代码智能体类
 * 继承BaseAgent并专注于代码实现
 */
export class CoderAgent extends BaseAgent {
    plannerAgentId;
    taskSpec;
    constructor(apiHandler, checkpointTracker, eventEmitter, plannerAgentId, taskSpec) {
     ...
     * 向计划智能体发送状态更新
     */
    sendStatusToPlannerAgent(statusMessage) {
     ...
     * 向计划智能体发送任务完成消息
     */
    sendTaskCompletionToPlannerAgent(result) {
        this.sendMessage(this.plannerAgentId, {
     ...
     * 向计划智能体发送错误消息
     */
    sendErrorToPlannerAgent(errorResult) {
        this.sendMessage(this.plannerAgentId, {
     ...
     */
    async simulateCodeImplementation() {
        // 模拟代码生成和实现过程
