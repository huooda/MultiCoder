...
export async function parseMentions(text, cwd, urlContentFetcher) {
...
function getWorkspaceProblems(cwd) {
    const diagnostics = vscode.languages.getDiagnostics();
    const result = diagnosticsToProblemsString(diagnostics, [vscode.DiagnosticSeverity.Error, vscode.DiagnosticSeverity.Warning], cwd);
    if (!result) {
