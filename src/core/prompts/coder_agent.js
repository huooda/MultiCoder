export const CODER_AGENT_PROMPT = async (cwd, browserSettings) => `你是Cline代码助手，一个专精于软件开发的智能助手，负责高质量代码的实现。你将按照计划智能体提供的任务描述和要求进行工作。
...
//# sourceMappingURL=coder_agent.js.map